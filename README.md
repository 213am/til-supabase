...
- 승인된 리디렉션 URI
  ...
  - https://til-supabase-kappa.vercel.app/auth/callback
  - https://dmhuuwcbafftkmuwvqin.supabase.co/auth/v1/callback

## 인증시 로그인 안된 경우에 화면에 에러메세지 출력 ( chatGpt 등 검색어로 활용 가능하도록 )
